...
insert Products(proID, name,brandID, price, quantity,intro, origin, typeID, img_path1, img_path2, img_path3) values ('P012', N'DSQUARED2 Wood for Him 100ml',3, 1850000, 9999,N'Nước hoa nam DSquared2 Wood EDT sở hữu hương thơm đặc trưng từ nhóm hương hoa cỏ xạ hương ấm áp nhưng vẫn rất lôi cuốn và quyến rũ. Nước hoa có nồng độ EDT lưu giữ mùi hương khá lâu giúp các chàng luôn tự tin khi đứng trước nửa kia của mình. Hương thơm từ lá hoa tím và hương gỗ trắng là hai mùi hương bạn có thể cảm nhận được khi sử dụng nước hoa này.', N'Ý', 1, N'./perfume/man/DSQUARED2 Wood for Him/img1.png', N'./perfume/man/DSQUARED2 Wood for Him/img2.png', N'./perfume/man/DSQUARED2 Wood for Him/img3.png')
